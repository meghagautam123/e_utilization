...
/*
https://github.com/Dev-Adnani/flutter-mvvm-template/blob/main/lib/view_model/userViewModel/user.view.model.dart
*/
...
class LoginScreenNew extends StatefulWidget
{
  ...
  @override
  State<LoginScreenNew> createState() => _LoginState();
}


class _LoginState extends State<LoginScreenNew>
{
  ...
  void initState() {
   ...
   //  authViewMode = Provider.of<AuthViewModel>(context);
    _getDeviceInfo();
  }
      ...
      body: Container(
        ...
        child: SafeArea(
                  ...
                  Row(
                    ...
                    children: [
                      Padding(
                        ...
                        child: Image.asset('assets/images/isro.png',width: 70,height:70),
                      ),
                      Padding(
                        padding: const EdgeInsets.fromLTRB(0.0,0.0,10.0,10.0),
                        child: Image.asset('assets/images/emblem.png',width: 70,height:70),
                      ),
                    ],
                  ),
          ...
          context, MaterialPageRoute(builder: (context) => SearchSanctionDemo()));*/
                                      ...
                                      Map<String, String> arguments = {'username': 'nr1023', 'password': 'root@123'};
                                      ...
                                      authViewMode?.loginApi(jsonBody,context);
